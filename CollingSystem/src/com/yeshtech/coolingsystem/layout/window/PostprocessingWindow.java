...
public class PostprocessingWindow {
	...
	protected void createContents() {
		...
		shell = new Shell();
		shell.setImage(SWTResourceManager.getImage(PostprocessingWindow.class,
				"/icon/App.ico"));
		shell.setSize(545, 442);
		shell.setText(loader
				.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW));

		Label lblResultFileName = new Label(shell, SWT.NONE);
		lblResultFileName.setBounds(10, 12, 94, 15);
		lblResultFileName
				.setText(loader
						.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_RESULTS_FILE_NAME));
		...
		tbtmExergyDestruction
				.setText(loader
						.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_EXERGY_DESTRUCTION));

		Composite composite_2 = new Composite(tabFolder, SWT.NONE);
		tbtmExergyDestruction.setControl(composite_2);

		Label label = new Label(composite_2, SWT.WRAP);
		label.setText(loader
				.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_COMPONENT_NAME));
		label.setBounds(49, 27, 66, 34);

		Label label_1 = new Label(composite_2, SWT.WRAP);
		label_1.setText(loader
				.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_COMPONENT_TYPE));
		...
		tbtmDesignParameter
				.setText(loader
						.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_DESIGN_PARAMETERS));
		...
		tbtmGraphics
				.setText(loader
						.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_GRAPHICS));

		Composite composite_4 = new Composite(tabFolder, SWT.NONE);
		tbtmGraphics.setControl(composite_4);

		Group grpComponentExergyDestruction = new Group(composite_4, SWT.NONE);
		grpComponentExergyDestruction
				.setText(loader
						.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_COMPONENT_EXERGY_DESTRUCTION));
		grpComponentExergyDestruction.setBounds(36, 10, 313, 108);

		Label lblColorScaleMinimum = new Label(grpComponentExergyDestruction,
				SWT.NONE);
		lblColorScaleMinimum.setBounds(10, 28, 126, 15);
		lblColorScaleMinimum
				.setText(loader
						.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_COLOR_SCALE_MINIMUM));

		Label lblColorScaleMaximum = new Label(grpComponentExergyDestruction,
				SWT.NONE);
		lblColorScaleMaximum
				.setText(loader
						.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_COLOR_SCALE_MAXIMUM));
		...
		grpLoopMassFlow
				.setText(loader
						.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_LOOP_MASS_FLOW_RATE));
		grpLoopMassFlow.setBounds(36, 134, 313, 102);

		Label lblMinimumThickness = new Label(grpLoopMassFlow, SWT.NONE);
		lblMinimumThickness
				.setText(loader
						.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_MINIMUM_THICKNESS));
		lblMinimumThickness.setBounds(10, 32, 126, 15);

		Label lblMaximumThickness = new Label(grpLoopMassFlow, SWT.NONE);
		lblMaximumThickness
				.setText(loader
						.getValue(LabelConstants.LAYOUT_POST_PROCESSING_WINDOW_MAXIMUM_THICKNESS));
